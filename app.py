...
# ENLACE DIRECTO DE TU HOJA DE GOOGLE (Sin depender de los Secrets de la página)
...
# CONEXIÓN FUERTE A GOOGLE SHEETS
try:
        ...
        if nuevo_excel_main is not None and conn is not None:
            if st.button("🔄 Inicializar Nueva Semana", use_container_width=True):
                try:
                    ...
                    # Guardar datos directo usando el link físico
...
# LEER DATOS DIRECTAMENTE CON EL ENLACE FISICO
