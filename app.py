...
# -------------------------------------------------------------------------
# INYECCIÓN CSS AVANZADA: ELIMINAR INTERFAZ DE DESARROLLO Y RESCATAR EL BOTÓN
# -------------------------------------------------------------------------
st.markdown("""
    <style>
        /* 1. Ocultar por completo la barra superior de desarrollo (Share, Edit, GitHub) */
        ...
        /* Eliminar espacios muertos superiores en el cuerpo de la página */
        .main .block-container { padding-top: 1rem !important; }
        
        /* 2. CREAR UN BOTÓN FLOTANTE INMUNE PARA EL MENÚ LATERAL */
        /* Lo movemos un poco hacia abajo (top: 15px) para que no choque con nada en el celular */
        [data-testid="stSidebarCollapseButton"] {
            visibility: visible !important;
            display: flex !important;
            background-color: #007bff !important; /* Color azul llamativo y profesional */
        ...
        /* Forzar que la flechita interna del botón sea blanca y visible */
