...
if os.path.exists(ARCHIVO_CSV) and os.path.exists(PLANTILLA_EXCEL):
    try:
        ...
        with col2:
            # INYECCIÓN CORREGIDA Y ALINEADA SIN ERRORES DE SINTAXIS
                    ...
                    if idx_sitio is None:
                        ...
                        for f in range(fila_titulos + 1, ws.max_row + 1):
                            ...
                            if cod_sitio in mapeo_realizo:
                                ...
                                # Forzar los bordes correctos
                                celda_r.border = borde_cuadrícula
                                celda_j.border = borde_cuadrícula
                                
                                # Copiar tipo de letra de la celda SITIO
                        ...
                        # Exportación del archivo final corregido
                        ...
                        st.success("¡Archivo oficial corregido! Descárgalo con el botón de arriba.")
