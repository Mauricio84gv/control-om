...
st.markdown("""
    <style>
        /* Ocultar barra de desarrollo superior (Share, Edit, GitHub) */
        ...
        /* FORZAR QUE EL BOTÓN DEL MENÚ LATERAL SIEMPRE SEA VISIBLE */
        [data-testid="stSidebarCollapseButton"] {
            visibility: visible !important;
            display: flex !important;
            background-color: #f0f2f6 !important; /* Un gris claro para que lo veas bien */
