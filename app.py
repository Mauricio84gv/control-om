...
# -------------------------------------------------------------------------
# INYECCIÓN CSS AVANZADA: ELIMINAR BARRA DE DESARROLLO DE STRALMIT COMPLETAMENTE
# -------------------------------------------------------------------------
st.markdown("""
    <style>
        /* Ocultar la barra superior negra de Streamlit Community Cloud (Share, Edit, etc.) */
        div[data-testid="stStatusWidget"] { display: none !important; }
        [data-testid="stDecoration"] { display: none !important; }
        [data-testid="stActionButton"] { display: none !important; }
        
        /* Ocultar el contenedor del header nativo por completo */
        header { 
        ...
        /* Ocultar el menú de tres puntos original */
        #MainMenu { visibility: hidden !important; }
        footer { visibility: hidden !important; }
        
        /* Ajustar el cuerpo de la página para que empiece desde arriba sin el hueco del header */
        .main .block-container { 
            padding-top: 1rem !important; 
        }
        
        /* Ocultar por completo el botón nativo de la barra lateral para evitar ruido visual */
