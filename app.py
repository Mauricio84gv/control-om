...
# -------------------------------------------------------------------------
# INYECCIÓN CSS: OCULTAR SOLO DESARROLLO Y FORZAR VISIBILIDAD DEL BOTÓN
# -------------------------------------------------------------------------
st.markdown("""
    <style>
        /* Ocultar botones de desarrollo específicos (Deploy, Share, GitHub, etc.) */
        [data-testid="stActionButton"] { display: none !important; }
        [data-testid="stDecoration"] { display: none !important; }
        
        /* Ocultar el menú original de tres puntos de la derecha */
        #MainMenu { visibility: hidden !important; }
        
        /* Eliminar el espacio muerto superior */
        .main .block-container { padding-top: 1.5rem !important; }
        footer { visibility: hidden !important; }
        
        /* FORZAR QUE EL BOTÓN FLOTANTE PARA ABRIR LA BARRA LATERAL SEA VISIBLE */
        [data-testid="stSidebarCollapseButton"] {
            visibility: visible !important;
            display: flex !important;
            background-color: #2e7d32 !important; /* Un color verde llamativo para que lo ubiques rápido */
        ...
        /* Asegurar que el icono de la flecha dentro del botón sea blanco */
